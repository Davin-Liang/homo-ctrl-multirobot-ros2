/// @file 4D 连续边界投影编队控制节点实现。
///
/// 数据流与原 FormationController 相同，使用 LpcController4DCont 作为后端。
...
// 构造函数
// ============================================================================
FormationController4DCont::FormationController4DCont()
: rclcpp::Node("formation_control_node_4d_cont")
{
  ...
  RCLCPP_INFO(get_logger(), "4D Continuous 编队控制节点已启动。");
...
// 定时器回调 — 主控制循环 (~20 Hz)
// ============================================================================
void FormationController4DCont::timer_cb()
{
