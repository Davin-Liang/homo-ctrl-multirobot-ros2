...
#include <memory>
#include "homo_multirobot_formation_control/homo_controller_6d_bearing.hpp"
#include "homo_multirobot_formation_control/kinematic_constraint.hpp"

class FormationController6DBearing : public rclcpp::Node
{
public:
  FormationController6DBearing();
...
private:
  ...
  std::unique_ptr<formation_control::LpcController6DBearing> ctrl_;
