"""
6D 运动学模型编队控制 — 离散多边形编队策略（m_p 个离散点 + tol 迟滞切换）。

与 formation_single_follower_6d（连续边界投影）的区别：
...
def generate_launch_description():
    ...
    node = Node(
        ...
        executable="formation_control_node_6d_disc",
        name="formation_control_node_6d_disc",
