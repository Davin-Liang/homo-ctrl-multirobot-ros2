...
config_file = os.path.join(
    ...
    "config", "formation_single_follower_4d_artstein.yaml")
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("use_hpc_nu_override", default_value="false",
                              description="Use a fixed feasible homogeneous degree for experiments."),
        DeclareLaunchArgument("hpc_nu_override", default_value="-0.30",
                              description="Fixed nu; must be inside the automatic feasible interval."),
