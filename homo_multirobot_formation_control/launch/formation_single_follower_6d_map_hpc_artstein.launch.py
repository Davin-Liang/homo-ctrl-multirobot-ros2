...
config_file = os.path.join(
    ...
    "config", "formation_single_follower_6d_map_hpc_artstein.yaml")
...
def generate_launch_description():
    ...
    controller = Node(
        ...
        executable="formation_control_node_6d_map_hpc_artstein",
        name="formation_control_node_6d_map_hpc_artstein",
