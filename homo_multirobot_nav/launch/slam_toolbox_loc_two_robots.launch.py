...
from launch.actions import DeclareLaunchArgument as _DeclareLaunchArgument, OpaqueFunction
...
config_file = os.path.join(
    ...
    "config", "slam_toolbox_loc_two_robots.launch.yaml")
...
def DeclareLaunchArgument(name, default_value=None, description=None):
    value = _launch_default(defaults[name]) if name in defaults else default_value
    return _DeclareLaunchArgument(name, default_value=value, description=description)
