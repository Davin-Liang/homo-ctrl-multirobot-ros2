...
表 3 进一步给出速度一致性指标。相对速度误差定义为 Leader 与 Follower 在平面内速度分量之差的模长；数值越小，表示 Follower 的实际运动速度与 Leader 越一致。

| 工况 | 全程平均相对速度误差 (m/s) | 末 10 s 平均相对速度误差 (m/s) |
| --- | ---: | ---: |
| Artstein-HPC，Leader 命令速度前馈开启 | 0.0856 | 0.0462 |
| Artstein-HPC，Leader 命令速度前馈关闭 | 0.0921 | 0.0505 |

*表 3　Leader 命令速度前馈开/关的速度一致性指标*
...
表 4 汇总了 Artstein-HPC 实验二参考组与 λ初值为 2.5 的 Artstein-LPC 实物记录，结果用于说明当前阶段的跟踪现象。
...
| 工况 | 全程平均绝对距离误差 (m) | 全程 RMS 距离误差 (m) | 末 10 s 平均绝对距离误差 (m) | 末 10 s 距离误差标准差 (m) |
| --- | ---: | ---: | ---: | ---: |
| Artstein-HPC，实验二参考组 | 0.1542 | 0.3145 | 0.0509 | 0.0585 |
| Artstein-LPC，λ初值=2.5 | 0.4144 | 0.4771 | 0.3411 | 0.3718 |

*表 4　Artstein-HPC 与 Artstein-LPC 的阶段性实物跟踪指标*

| 工况 | 全程平均相对速度误差 (m/s) | 末 10 s 平均相对速度误差 (m/s) |
| --- | ---: | ---: |
| Artstein-HPC，实验二参考组 | 0.0978 | 0.0674 |
| Artstein-LPC，λ初值=2.5 | 0.2444 | 0.2478 |

*表 5　Artstein-HPC 与 Artstein-LPC 的速度一致性指标*
